...
function(reason_print_target_properties TARGET_NAME)
  ...
  # @TODO compile define
  get_target_property(t_INCLUDE_DIRS "${TARGET_NAME}" "INCLUDE_DIRECTORIES")
  if("${t_INCLUDE_DIRS}" STREQUAL "t_INCLUDE_DIRS-NOTFOUND")
    reason_verbose("  INCLUDE_DIRECTORIES: None")
  else()
    reason_verbose("  INCLUDE_DIRECTORIES:")
  ...
  get_target_property(t_LINK_LIBS "${TARGET_NAME}" "LINK_LIBRARIES")
  if("${t_LINK_LIBS}" STREQUAL "t_LINK_LIBS-NOTFOUND")
    reason_verbose("  LINK_LIBRARIES: None")
  else()
    reason_verbose("  LINK_LIBRARIES:")
